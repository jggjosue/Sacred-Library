...
export function ContentBrowser() {
  ...
  const categories = [
    {
      id: 'scripture',
      title: t('explore.scripture'),
      description: t('explore.scriptureDesc'),
      image: PlaceHolderImages.find(img => img.id === 'scripture-cat'),
      count: '30,000+ Verses'
    },
    {
      id: 'devotionals',
      title: t('explore.devotionals'),
      description: t('explore.devotionalsDesc'),
      image: PlaceHolderImages.find(img => img.id === 'devotional-cat'),
      count: '500+ Guides'
    },
    {
      id: 'plans',
      title: t('explore.plans'),
      description: t('explore.plansDesc'),
    ...
    <section id="explore" className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-12 md:px-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-headline font-bold mb-4 text-foreground">{t('explore.title')}</h2>
                ...
                <Card className="group cursor-pointer overflow-hidden border-border bg-card hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                  ...
                  <CardContent className="flex justify-end pt-0">
                    <div className="flex items-center text-primary font-medium group-hover:translate-x-1 transition-transform">
                      {t('explore.browse')} <ChevronRight className="w-4 h-4 ml-1" />
                    </div>
                  </CardContent>
                </Card>
              </CarouselItem>
