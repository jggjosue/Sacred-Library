        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <section className="lg:col-span-8 space-y-12">
            <header className="space-y-2">
              <h1 className="text-5xl font-headline font-bold text-slate-900 dark:text-slate-100 tracking-tight">{t('profile.title')}</h1>
            ...
            <div className="space-y-8">
              <h3 className="text-2xl font-headline font-bold text-slate-900 dark:text-slate-100">{t('profile.recentActivity')}</h3>
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 flex justify-between items-center group hover:border-blue-100 transition-colors">
                    <div>
  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm space-y-6">
      ...
      <div className="space-y-2">
        <h4 className="text-slate-400 dark:text-slate-500 font-bold text-xs uppercase tracking-widest">{title}</h4>
        <p className="text-4xl font-headline font-bold text-slate-900 dark:text-slate-100">{count}</p>
