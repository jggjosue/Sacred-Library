...
export default function DevotionalDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/30 dark:bg-slate-900/40 flex flex-col">
      <Navbar />
      ...
      <main className="flex-1 pt-32 pb-48">
        <article className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center space-y-4 mb-12">
            <h1 className="text-5xl md:text-7xl font-headline font-bold text-slate-900 dark:text-slate-100 leading-tight">
              Morning Gratitude
            </h1>
          ...
          {/* Content Body */}
          <div className="max-w-2xl mx-auto space-y-8 text-lg leading-relaxed text-slate-700 dark:text-slate-300 font-body">
            <p>
            ...
            <div className="my-16 p-10 bg-blue-50/50 rounded-r-[2.5rem] border-l-4 border-blue-600 relative overflow-hidden">
              <blockquote className="space-y-4 relative z-10">
                <p className="text-3xl font-headline italic font-bold text-slate-800 dark:text-slate-200 leading-tight">
      ...
      <div className="fixed bottom-12 left-1/2 -translate-x-1/2 w-full max-w-2xl px-6 z-40">
        <div className="bg-white/80 backdrop-blur-xl border border-slate-100 dark:border-slate-800 rounded-full shadow-2xl p-4 flex items-center gap-6">
          <Button 
          ...
          <div className="flex-1 flex items-center gap-4">
            <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 w-8">0:00</span>
            <Slider defaultValue={[15]} max={100} step={1} className="flex-1" />
            <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 w-8">4:12</span>
          </div>

          <div className="flex items-center gap-4 border-l border-slate-100 dark:border-slate-800 pl-6 pr-2">
            <div className="flex items-center gap-2">
              <button className="text-[10px] font-bold text-slate-400 dark:text-slate-500 hover:text-blue-600">A-</button>
              <button className="text-[10px] font-bold text-slate-900 dark:text-slate-100 hover:text-blue-600">A+</button>
            </div>
