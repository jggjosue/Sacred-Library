        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8">
            <div className="relative overflow-hidden rounded-[2.5rem] bg-black text-white min-h-[500px] flex flex-col justify-end p-8 md:p-12 shadow-2xl">
              ...
              <div className="relative z-10 space-y-6">
                <span className="text-xs font-bold tracking-[0.2em] uppercase text-slate-400">Verse of the Day</span>
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-headline italic leading-tight max-w-2xl">
                  "For I know the plans I have for you," declares the LORD, "plans to prosper you and not to harm you, plans to give you hope and a future."
                </h1>
                <p className="text-lg text-slate-300 font-medium">— Jeremiah 29:11</p>
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="space-y-6">
              <h2 className="text-4xl font-headline font-bold text-slate-900">My Journey</h2>
              ...
              <Card className="border-none shadow-xl shadow-slate-200/50 rounded-[2rem] overflow-hidden bg-white">
                <CardContent className="p-8 space-y-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold text-slate-900">The Gospels in 30 Days</h3>
                  ...
                  <div className="space-y-3 pt-2">
                    <div className="flex justify-between text-xs font-bold">
                      <span className="text-slate-400">Day 5 of 30</span>
                      <span className="text-blue-600">16%</span>
                    </div>
                    <Progress value={16} className="h-2 bg-slate-100" />
                  </div>

                  <Button className="w-full bg-slate-50 hover:bg-slate-100 text-blue-600 border-none shadow-none rounded-full py-6 h-auto text-sm font-bold group">
                    Continue Reading
